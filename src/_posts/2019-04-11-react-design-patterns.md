...
I'm follwing [Airbnb styleguide](https://github.com/airbnb/javascript/tree/master/react) and using  react in pattern books for references https://github.com/krasimir/react-in-patterns, <https://github.com/vasanthk/react-bits>
...
4. Using simple state management library for small application
   1. Honorable mention libraries: [pure-store](https://github.com/gunn/pure-store), [unstated](https://github.com/jamiebuilds/unstated) and [unistore](https://github.com/developit/unistore)other approches are shown at [React State Musuem](https://github.com/GantMan/ReactStateMuseum) which good place for reviewing react state management library.
...
Read more how to implement in each state management library in [React State Musuem](https://github.com/GantMan/ReactStateMuseum)
...
- [React State Musuem](https://github.com/GantMan/ReactStateMuseum)
